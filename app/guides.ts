...
export const guides: Guide[] = [
  {
    ...
    sections: [
      ...
      {
        heading: "2026년 계산에 적용한 기준",
        paragraphs: [
          "2026년 7월 기준 국민연금 근로자 부담률은 4.75%이고 기준소득월액은 41만원에서 659만원 사이로 적용됩니다. 건강보험 근로자 부담률은 3.595%, 장기요양보험료는 건강보험료의 약 13.14%, 고용보험 근로자 부담률은 0.9%입니다.",
          "소득세는 국세청 근로소득 간이세액표의 실제 원천징수액과 개인별 공제 조건에 따라 달라질 수 있으므로 계산기는 예상값을 제공합니다.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "많이 찾는 아파트 면적을 평으로 바꾸면",
        paragraphs: ["다음 값은 전용면적 자체를 ㎡에서 평으로 단순 환산한 결과입니다. 분양 현장에서 부르는 평형은 공급면적에 따라 달라집니다."],
        bullets: [
          "59㎡ ≈ 17.8평",
          "74㎡ ≈ 22.4평",
          "84㎡ ≈ 25.4평",
