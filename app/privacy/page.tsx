  ...
  return (
    <main>
      ...
      <article className="policy-page">
        ...
        <p>바로계산은 방문 현황과 서비스 이용 흐름을 파악하기 위해 Google Analytics 4를 사용합니다. 이 과정에서 방문 페이지, 접속 시각, 대략적인 지역, 브라우저·기기 정보와 쿠키 또는 유사 식별자가 처리될 수 있습니다. 계산기에 입력한 연봉, 주소, 금액 등의 값은 Analytics 이벤트로 전송하지 않습니다.</p>
        <p>Analytics 측정을 원하지 않는 사용자는 <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noreferrer">Google Analytics 차단 브라우저 부가기능</a>을 사용할 수 있습니다. 광고 저장 및 광고 개인 최적화 신호는 기본적으로 사용하지 않습니다.</p>
        <h2>광고와 쿠키</h2>
